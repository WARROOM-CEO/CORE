...
- Write descriptions that clearly indicate when to activate — include Thai phrases
- Include reference materials in subdirectories for complex skills
- Append `-th` suffix to skill names to avoid conflicts with official skills
- Test that the skill activates for expected queries in both Thai and English
