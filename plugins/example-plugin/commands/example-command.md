---
description: An example slash command that demonstrates command frontmatter options (legacy format) — Thai edition. ตัวอย่าง slash command รูปแบบเก่าสำหรับ Plugin ภาษาไทย
...
# Example Command (Legacy `commands/` Format) — Thai Edition
